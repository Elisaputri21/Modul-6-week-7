...
<nav class="navbar navbar-expand-md navbar-dark bg-primary">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <hr class="d-md-none text-white-50">
            <a href="<?php echo e(route('profile')); ?>" class="btn btn-outline-light
my-2 ms-md-auto"><i
                    class="bi-person-circle me-1"></i> My Profile</a>
        </div>
    </div>
</nav>
<?php /**PATH C:\Users\ASUS\OneDrive\Desktop\Praktikum Framework\Modul6\resources\views/layouts/nav.blade.php ENDPATH**/ ?>